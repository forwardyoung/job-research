...
### 🔎 [그리팅](https://career.doodlin.co.kr/o/65799)

**주요 업무**

- 그리팅 서비스의 ATS 기능(지원서 관리, 면접 관리 등) 개발해요
- MSA 환경에서의 아키텍처 설계 및 전환을 함께 해요
- 보다 나은 서비스 제작을 위한 아이디어 제시 및 고도화 해요



**자격요건**

* Java 또는 Kotlin 기반의 백엔드 개발 경험이 1년 이하 이신분
* MySQL, MongoDB 기반의 데이터 모델 설계 경험이 있으신 분
* 비동기 처리 (MQ, Kafka 등) 에 대한 이해 혹은 프로젝트 경험이 있으신 분
* 활발하고 적극적인 커뮤니케이션 능력을 가지신 분



**우대사항**

* MSA 기반의 애플리케이션 아키텍처 구성에 관심이 있으신 분
* TDD 기반의 소프트웨어 개발 경험이 있으신 분
* Domain Driven Design에 대한 이해가 있으신 분
* 끊임없는 고민과 토론을 바탕으로 제품을 성장시켜 나가실 분
...
- Spring Boot(Kotlin), Nest.js(Typescript)
- MySQL, MongoDB, Redis
- AWS, Kubernetes
- RabbitMQ, Kafka

### 🔎 [스매치코퍼레이션](https://smatchcorporation.career.greetinghr.com/o/66014)

**주요 업무**
> 스매치 프로덕트 개발 및 신규 서비스 개발을 위해 필요한 기능 개발 및 서버 인프라 개선을 통해 실제 기능하는 서비스를 만들어가는 업무를 진행합니다.

[상세 업무]
- Python, Typescript 기반으로 백엔드 비지니스 로직을 개발하고 배포합니다.
- FastAPI, Nest.js를 활용하여 RESTful API를 만드는 역할을 합니다.
- 빠른 속도로 성장하는 스타트업에서 건강한 개발팀 문화를 정착시키는데 기여합니다.
- GraphQL Resolver를 구현합니다.
...
* 1년 이상의 경력 백엔드 개발 경력
* SQL 작성 가능하신 분
* 웹서비스에 대한 기초 지식을 가지신 분
* 실수를 공유하는 것을 두려워하지 않고 실패보다 성장에 초점을 맞추시는 분
* 적극적으로 의견을 내고 커뮤니케이션하며 동료와 협업을 즐기시는 분
* 변화를 두려워하지 않고 새로운 기술을 학습하며 꾸준한 성장을 즐기시는 분
...
* RDBMS 개발 경험이 있으신 분
* Backend Production 환경 실무 경험이 있으신 분
* 좋은 코드, 서비스 품질을 위해 고민하고 실천하실 분
